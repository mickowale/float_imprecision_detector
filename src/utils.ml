...
let get_round_mode = Mpfr.get_default_rounding_mode
...
let neg_fpred = function 
  | Llvm.Fcmp.Oeq -> Llvm.Fcmp.One
  | Llvm.Fcmp.Ueq -> Llvm.Fcmp.Une
  | Llvm.Fcmp.One -> Llvm.Fcmp.Oeq
  | Llvm.Fcmp.Une -> Llvm.Fcmp.Oeq
  | Llvm.Fcmp.Olt -> Llvm.Fcmp.Oge
  | Llvm.Fcmp.Ult -> Llvm.Fcmp.Uge
  | Llvm.Fcmp.Ole -> Llvm.Fcmp.Ogt
  | Llvm.Fcmp.Ule -> Llvm.Fcmp.Ugt
  | Llvm.Fcmp.Ogt -> Llvm.Fcmp.Ole
  | Llvm.Fcmp.Ugt -> Llvm.Fcmp.Ule
  | Llvm.Fcmp.Oge -> Llvm.Fcmp.Olt
  | Llvm.Fcmp.Uge -> Llvm.Fcmp.Ult
  | Llvm.Fcmp.True -> Llvm.Fcmp.False
  | Llvm.Fcmp.False -> Llvm.Fcmp.True
  | Llvm.Fcmp.Ord -> Llvm.Fcmp.Uno
  | Llvm.Fcmp.Uno -> Llvm.Fcmp.Ord
